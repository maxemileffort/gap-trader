...
recent_gap_down = list_of_files[-1] # last file is gap downs, due to order in which they are scraped
recent_gap_up = list_of_files[-2] # second to last will be gap ups
